...
for i, bed in ipairs(beds_list) do
	...
	minetest.register_node("beds:bed_bottom_"..color, {
		description = S(bed[1]),
		drawtype = "nodebox",
		tiles = {"beds_bed_top_bottom_"..color..".png", "default_wood.png",
			"beds_bed_side_"..color..".png", "beds_bed_side_"..color..".png",
			"beds_bed_side_"..color..".png", "beds_bed_side_"..color..".png"},
		paramtype = "light",
		paramtype2 = "facedir",
		stack_max = 1,
	...
	minetest.register_node("beds:bed_top_"..color, {
		...
		tiles = {"beds_bed_top_top_"..color..".png", "default_wood.png",
			"beds_bed_side_top_r_"..color..".png", "beds_bed_side_top_l_"..color..".png",
			"beds_bed_top_front.png", "beds_bed_side_"..color..".png"},
		paramtype = "light",
		paramtype2 = "facedir",
		groups = {snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3},
		sounds = default.node_sound_wood_defaults(),
